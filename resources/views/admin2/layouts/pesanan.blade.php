                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Pesanan Alamat Sendiri</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header no-bd">
                                                                    <h5 class="modal-title">
                                                                        <span class="fw-mediumbold">Edit Pesanan Alamat
                                                                            Sendiri</span>
                                                                    </h5>
                                                                ...
                                                                <form action="/data-pesanan/{{ $data->id }}"
                                                                    method="POST">
                                                                    @method('put')
                                                                    @csrf
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <div class="form-floating mb-3">
                                                                                        <input class="form-control"
                                                                                            ...
                                                                                            required>
                                                                                        <label for="floatingInput"
                                                                                            name="tanggal_datang">Tanggal Datang
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="modal fade" id="detail{{ $data->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-scrollable modal-lg"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header no-bd">
                                                                    <h5 class="modal-title">
                                                                        <span class="fw-mediumbold">Detail Pesanan
                                                                            Alamat Sendiri</span>
                                                                    </h5>
                                                                    <button type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="col-7">
                                                                            <p>: {{ $data->relasikecamatan->kecamatan }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="col-7">
                                                                            <p>: {{ $data->relasiteknisi->nama_teknisi }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="col-7">
                                                                            <p>: {{ $data->relasiwaktu->waktu_datang }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                    ...
                                                                    <div
                                                                        class="modal-footer d-flex justify-content-center">
                                                                        <a href="/surat-tugas/{{ $data->id }}"
                                                                            target="_blank"
                                                                            class="btn btn-dark">PDF</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
