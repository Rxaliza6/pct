											...
											@foreach($admin as $data)
														...
														<div class="modal-content">
															<div class="modal-header no-bd">
																<h5 class="modal-title">
																	<span class="fw-mediumbold">Edit Admin</span> 
																</h5>
																<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																	<span aria-hidden="true">&times;</span>
																</button>
															</div>
															<form action="/data-akun-admin/{{ $data->id }}" method="POST">
																@method('put')
																@csrf
																		...
																		<div class="row">
																			<div class="col-sm-12">
																				<div class="form-floating mb-3">
																					<input class="form-control" type="text" name="nama" placeholder="nama" value="{{$data->nama}}" required>
																			...
																			<div class="col-md-6 pr-0">
																				<div class="form-floating mb-3">
																					<input class="form-control" type="text" name="email" placeholder="Email" value="{{$data->email}}" required>
												...
												<div class="modal fade" id="detail{{ $data->id }}" tabindex="-1" role="dialog" aria-hidden="true">
													<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
														...
														<div class="modal-header no-bd">
															<h5 class="modal-title">
															<span class="fw-mediumbold">Detail Admin</span> 
															</h5>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
															<span aria-hidden="true">&times;</span>
															</button>
														...
														<div class="modal-body">
															...
															<div class="modal-footer d-flex justify-content-center">
																<form action="/data-akun-admin/{{ $data->id }}" method="POST">
																	@csrf
																	@method('delete')
																	<input type="submit" class="btn btn-primary" value="Hapus" {{ $data->id == auth()->user()->id ? 'disabled' : '' }}>
																</form>
															</div>
														</div>
													</div>
  ...
  <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header no-bd">
          <h5 class="modal-title">
            <span class="fw-mediumbold">Tambah Admin</span> 
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
		<form action="/data-akun-admin/tambah" method="POST">
			@csrf
			<div class="modal-body">
